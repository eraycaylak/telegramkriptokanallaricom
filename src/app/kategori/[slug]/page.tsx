  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900">{cat.name} Telegram Kanalları</h1>
      ...
      <Link href="/kanallar" className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-700 mt-8 transition-colors">
